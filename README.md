...
* Use of parallel arrays as global variables to track data: This is not efficient and introduces poor scalability, may introduce issues that are not easy to track, and it cannot be easily reused if the data changes. 
